...
public class GatewayRouteController {
    ...
    @ApiImplicitParam(paramType = "query", name = "uri", value = "网关路由路径", required = true, dataType = "string")
    @ApiResponses(
    ...
    public Result search(@Valid @RequestBody GatewayRouteQueryForm gatewayRouteQueryForm) {
        ...
        //相当于List<GatewayRouteVo> gatewayRoutesVo = gatewayRoutes.stream().map(gatewayRoute->new GatewayRouteVo(gatewayRoute)).collect(Collectors.toList());
